...
switch (_filter) do
{
	...
	{	
		...
		_ret set[count _ret,["BWA3_Uniform_Crew_Fleck",nil,5000]];	
		_ret set[count _ret,["BWA3_Uniform_Tropen",nil,5000]];	
		_ret set[count _ret,["BWA3_Uniform2_Tropen",nil,5000]];	
		_ret set[count _ret,["BWA3_Uniform3_Tropen",nil,5000]];		
		_ret set[count _ret,["BWA3_Uniform_Ghillie_Tropen",nil,50000]];	
		_ret set[count _ret,["BWA3_Uniform_Crew_Tropen",nil,5000]];			
		_ret set[count _ret,["BWA3_Uniform_Ghillie_Fleck",nil,50000]];		
	...
	case 1:
	{
		...
		_ret set[count _ret,["BWA3_M92_Tropen",nil,500]];	
		_ret set[count _ret,["BWA3_Booniehat_Tropen",nil,500]];
		_ret set[count _ret,["BWA3_OpsCore_Tropen",nil,500]];
		_ret set[count _ret,["BWA3_OpsCore_Tropen_Camera",nil,500]];
	...
	case 2:
	{
		...
		_ret set[count _ret,["G_mas_wpn_wrap_c",nil,550]];
	...
	{			
		...
		_ret set[count _ret,["BWA3_Vest_Tropen",nil,10000]];
		_ret set[count _ret,["BWA3_Vest_Grenadier_Tropen",nil,10000]];
		_ret set[count _ret,["BWA3_Vest_Leader_Tropen",nil,10000]];
		_ret set[count _ret,["BWA3_Vest_Marksman_Tropen",nil,10000]];
		_ret set[count _ret,["BWA3_Vest_Autorifleman_Tropen",nil,10000]];		
		_ret set[count _ret,["BWA3_Vest_Medic_Tropen",nil,10000]];
		_ret set[count _ret,["BWA3_Vest_Rifleman1_Tropen",nil,10000]];		
